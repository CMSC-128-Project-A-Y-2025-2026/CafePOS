...
import { menuCategories } from '../mockData'; // Import fixed categories
...
export default function ProductFormModal({ title, initialData, onClose, onSave }: ProductFormModalProps) {
      ...
      <div className="w-full max-w-lg rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <input
              type="number" id="price" value={price} onChange={(e) => setPrice(e.target.value)} min="0"
              className="mt-1 block w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-[#6290C3] focus:ring-[#6290C3] text-gray-900 transition-all"
              required
            />
          </div>
