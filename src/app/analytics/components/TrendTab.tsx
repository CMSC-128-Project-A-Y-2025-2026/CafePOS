...
import { salesByHourData, salesByDayData } from '../mockData';
...
export default function TrendTab() {
  ...
  return (
    <div className="flex h-full flex-col gap-3 pt-2"> 
      ...
      <div className="h-[370px] bg-gray-50 p-3 rounded-xl shadow-inner border border-gray-200" style={{ maxHeight: '380px' }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 20, right: 30, bottom: 0, left: 30 }}>
