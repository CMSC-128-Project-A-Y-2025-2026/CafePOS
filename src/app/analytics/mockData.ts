...
export const salesByHourData: SalesItem[] = [
  ...
  { hour: "12 PM", sales: 1942 },
  { hour: "1 PM", sales: 971 },
  { hour: "2 PM", sales: 486 },
  { hour: "3 PM", sales: 450 },
  { hour: "4 PM", sales: 1200 },
  { hour: "5 PM", sales: 1800 },
  { hour: "6 PM", sales: 1500 },
];

export const salesByDayData: SalesItem[] = [
  { day: "Sun", sales: 1300, color: "#FFB6C1" },
  { day: "Mon", sales: 1200, color: "#D2B48C" },
  { day: "Tue", sales: 1800, color: "#98FB98" },
  { day: "Wed", sales: 2100, color: "#20B2AA" },
  { day: "Thu", sales: 1300, color: "#ADD8E6" },
  { day: "Fri", sales: 1250, color: "#DDA0DD" },
...
export const allTopBestsellers: TopSellerProduct[] = [
  ...
  {
    id: 16,
    productName: "Green Apple with Yakult",
    price: 85,
    category: "soda-based",
    itemsSold: 48,
  },
  ...
  // Pasta & Sandwich
  {
    ...
    price: 149,
    category: "pasta-sandwich",
    itemsSold: 68,
  },
  {
    id: 20,
    productName: "Hotdog Clubhouse",
    price: 109,
    category: "pasta-sandwich",
    itemsSold: 50,
  },
